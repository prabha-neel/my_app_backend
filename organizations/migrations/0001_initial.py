    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(blank=True, help_text='e.g. Agra, Delhi, Mumbai', max_length=100, null=True, verbose_name='City')),
                ('locality', models.CharField(blank=True, help_text='e.g. Sanjay Place, Civil Lines', max_length=255, null=True, verbose_name='Locality / Area')),
                ('pincode', models.CharField(blank=True, max_length=10, null=True, validators=[django.core.validators.RegexValidator('^\\d{6,10}$', 'Enter a valid pincode.')], verbose_name='Pincode')),
                ('instruction_medium', models.CharField(choices=[('english', 'English'), ('hindi', 'Hindi'), ('bilingual', 'Bilingual/Both')], default='english', max_length=20, verbose_name='Medium of Instruction')),
                ('gender_type', models.CharField(choices=[('coed', 'Co-Ed'), ('boys', 'Boys Only'), ('girls', 'Girls Only')], default='coed', max_length=20, verbose_name='Gender Type')),
                ('fee_category', models.CharField(blank=True, choices=[('budget', 'Budget Friendly'), ('mid_range', 'Mid-Range'), ('premium', 'Premium / High-End')], max_length=20, null=True, verbose_name='Fee Category')),
                ('monthly_fees_min', models.PositiveIntegerField(blank=True, null=True, verbose_name='Approx Min Monthly Fee')),
                ('has_transport', models.BooleanField(default=False, verbose_name='Transport Facility')),
                ('has_hostel', models.BooleanField(default=False, verbose_name='Hostel Facility')),
                ('has_smart_class', models.BooleanField(default=False, verbose_name='Smart Classes')),
                ('has_library', models.BooleanField(default=False, verbose_name='Library')),
                ('has_playground', models.BooleanField(default=False, verbose_name='Playground')),
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='owned_organizations', to=settings.AUTH_USER_MODEL, verbose_name='Organization Admin / Owner')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_organizations', to=settings.AUTH_USER_MODEL, verbose_name='Created By (Super-Admin)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='school_admin_profile', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
